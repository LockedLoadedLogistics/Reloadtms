...
*
*/
define('APP_BASE_URL', 'http://localhost:8081/');
...
*/
define('APP_ENC_KEY', '[encryption_key]'); // This will be set automatically during installation

/**
 * Database Credentials
 * The hostname of your database server
 */
define('APP_DB_HOSTNAME', 'localhost'); // or your actual DB host

/**
 * The username used to connect to the database
 */
define('APP_DB_USERNAME', 'reloaded@strappedandloaded.us');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Cde44921!'); // your actual DB password
